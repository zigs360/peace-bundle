              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-gray-900">{t('contact.emailUs')}</h3>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-gray-900">{t('contact.callUs')}</h3>
                      <p className="mt-1 text-gray-500">
                        <a href="tel:+2348000000000" className="hover:text-primary-600 transition">+234 80 354 468 65</a>
                        <br />
                        <span className="text-sm">{t('contact.businessHours')}</span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-gray-900">{t('contact.visitUs')}</h3>
                      <p className="mt-1 text-gray-500">
                        1 Tashan Magarya,<br />
                ...
                <div className="pt-8 border-t border-gray-200">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">{t('contact.liveChat')}</h3>
                  ...
                  <a href="/login" className="inline-flex items-center text-primary-600 font-medium hover:text-primary-700">
                    {t('contact.loginToChat')} <MessageSquare className="w-4 h-4 ml-2" />
                  </a>
                </div>
              </div>
            </FadeIn>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Sales Inquiry">{t('contact.topicSalesInquiry')}</option>
                      <option value="Partnership">{t('contact.topicPartnership')}</option>
                      <option value="Technical Support">{t('contact.topicTechnicalSupport')}</option>
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <span className="flex items-center">
                        {t('contact.sendMessage')} <Send className="ml-2 w-4 h-4" />
                      </span>
                    )}
                  </button>
                </form>
